// デザインシステムのReactコンポーネント (shadcn/Radix流のプリミティブ) の取込口。
// アプリ側はここからだけimportする — DS更新 (npm run ds:update) が唯一の変更経路。
export { Button } from "@kensnzk/koyu-design-system/components/core/Button.jsx";
export { IconButton } from "@kensnzk/koyu-design-system/components/core/IconButton.jsx";
